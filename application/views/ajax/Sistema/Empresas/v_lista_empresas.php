<div class="row hidden-mobile">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-align-right">
		<div class="page-title">
			<a href="Sistema/Empresa/NuevaEmpresa" data-backdrop="static" data-toggle="modal" data-target="#remoteModal" id="btnNuevo" class="btn btn-primary">Nueva</a>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		$(".btnEliminar").click(function(e) {
			...
			$.SmartMessageBox({
				title : "Eliminar",
				content : "Esta seguro de eliminar esta empresa del sistema?",
				buttons : '[No][Si]'
