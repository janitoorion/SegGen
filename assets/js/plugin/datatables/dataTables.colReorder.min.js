...
! function(a, b, c) {
    ...
    var g = function(a, g) {
        ...
        a.fn.dataTableExt.oApi.fnColReorder = function(b, c, g) {
            var h, i, j, k, l, m, n = a.fn.dataTable.Api ? !0 : !1,
            ...
            if (c != g) {
                ...
                if (null !== b.aaSortingFixed)
                    for (h = 0, i = b.aaSortingFixed.length; i > h; h++) b.aaSortingFixed[h][0] = r[b.aaSortingFixed[h][0]];
                for (h = 0, i = o; i > h; h++) {
                ...
                if (b.aoColumns[c].bVisible) {
                    ...
                    if (null !== b.nTFoot)
                        for (l = b.nTFoot.getElementsByTagName("tr"), h = 0, i = l.length; i > h; h++) f(l[h], s, t);
                ...
                a(b.oInstance).trigger("column-reorder", [b, {
                    "iFrom": c,
                    "iTo": g,
                    "aiInvertMapping": r
                }])
